...
Runs on an x86 dev host, NOT on the board. Produces whisper_tiny_10s_wi8ai16.tflite
...
INT8_MODEL = MODEL_DIR / "whisper_tiny_10s_wi8ai16.tflite"
...
def main():
    ...
    qt.load_quantization_recipe(recipe.static_wi8_ai16())
    ...
    print("[5/5] done -- validate separately, exported model I/O tensors are "
          "int8 (weights) / int16 (activations), not float32")
